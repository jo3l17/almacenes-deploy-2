...
var Property = /** @class */ (function () {
    function Property(id, title, desc, propertyType, propertyStatus, city, zipCode, neighborhood, street, location, formattedAddress, features, featured, priceDollar, priceEuro, bedrooms, bathrooms, garages, area, yearBuilt, ratingsCount, ratingsValue, additionalFeatures, gallery, plans, videos, published, lastUpdate, views) {
        this.id = id;
        this.title = title;
        this.desc = desc;
    ...
    Property.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String },
...
var AdditionalFeature = /** @class */ (function () {
    function AdditionalFeature(id, name, value) {
        this.id = id;
        this.name = name;
        this.value = value;
    }
    AdditionalFeature.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String }
    ]; };
...
var Gallery = /** @class */ (function () {
    function Gallery(id, small, medium, big) {
        this.id = id;
        this.small = small;
        this.medium = medium;
        this.big = big;
...
var Plan = /** @class */ (function () {
    function Plan(id, name, desc, area, rooms, baths, image) {
        this.id = id;
        this.name = name;
        this.desc = desc;
        this.area = area;
...
var Video = /** @class */ (function () {
    function Video(id, name, link) {
        this.id = id;
        this.name = name;
        this.link = link;
    }
    Video.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String }
    ]; };
...
var Pagination = /** @class */ (function () {
    function Pagination(page, perPage, prePage, nextPage, total, totalPages) {
        this.page = page;
...
var Almacen = /** @class */ (function () {
    function Almacen(idInstalacion, nombreInstalacion, nroInstalacion, paginaWeb, regionInstalacion, comunaInstalacion, telefonoInstalacion, emailInstalacion, direccionInstalacion, latitudInstalacion, longitudInstalacion, t_miniBodega, t_instalacion_amenidads, t_unidades, gallery) {
    ...
    Almacen.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: Number },
        { type: String },
...
var miniBodega = /** @class */ (function () {
    function miniBodega(idOperador, nombreOperador, paginaWeb, region, numeroInstalaciones, comuna, telefono, email, direccion, usu_id) {
    ...
    miniBodega.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String },
...
var Amenidades = /** @class */ (function () {
    function Amenidades(idInstalacionAmenidad, id_amenidad, id_instalacion, nombre, t_amenidade) {
    ...
    Amenidades.ctorParameters = function () { return [
        { type: Number },
        { type: Number },
        { type: Number },
        { type: String },
...
var Unidades = /** @class */ (function () {
    function Unidades(idUnidad, largo, ancho, areaTotal, TarifaMensual, Visible, id_instalacion) {
    ...
    Unidades.ctorParameters = function () { return [
        { type: Number },
        { type: Number },
        { type: Number },
        { type: Number },
...
var Amenidad = /** @class */ (function () {
    function Amenidad(idAmenidades, nombreAmenidad) {
        this.idAmenidades = idAmenidades;
        this.nombreAmenidad = nombreAmenidad;
    }
    Amenidad.ctorParameters = function () { return [
        { type: Number },
        { type: String }
    ]; };
    return Amenidad;
...
/* harmony import */ var ngx_input_file__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-input-file */ "./node_modules/ngx-input-file/fesm5/ngx-input-file.js");
...
var routes = [
    {
        ...
        component: _pages_pages_component__WEBPACK_IMPORTED_MODULE_1__["PagesComponent"], children: [
            ...
            { path: 'about', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-about-about-module */ "pages-about-about-module").then(__webpack_require__.bind(null, /*! ./pages/about/about.module */ "./src/app/pages/about/about.module.ts")).then(function (m) { return m.AboutModule; }); } },
            { path: 'contact', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-contact-contact-module */ "pages-contact-contact-module").then(__webpack_require__.bind(null, /*! ./pages/contact/contact.module */ "./src/app/pages/contact/contact.module.ts")).then(function (m) { return m.ContactModule; }); } },
            { path: 'properties', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-properties-properties-module */ "pages-properties-properties-module").then(__webpack_require__.bind(null, /*! ./pages/properties/properties.module */ "./src/app/pages/properties/properties.module.ts")).then(function (m) { return m.PropertiesModule; }); } },
            { path: 'agents', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-agents-agents-module */ "pages-agents-agents-module").then(__webpack_require__.bind(null, /*! ./pages/agents/agents.module */ "./src/app/pages/agents/agents.module.ts")).then(function (m) { return m.AgentsModule; }); } },
            { path: 'compare', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-compare-compare-module */ "pages-compare-compare-module").then(__webpack_require__.bind(null, /*! ./pages/compare/compare.module */ "./src/app/pages/compare/compare.module.ts")).then(function (m) { return m.CompareModule; }); } },
            { path: 'pricing', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-pricing-pricing-module */ "pages-pricing-pricing-module").then(__webpack_require__.bind(null, /*! ./pages/pricing/pricing.module */ "./src/app/pages/pricing/pricing.module.ts")).then(function (m) { return m.PricingModule; }); } },
            { path: 'faq', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-faq-faq-module */ "pages-faq-faq-module").then(__webpack_require__.bind(null, /*! ./pages/faq/faq.module */ "./src/app/pages/faq/faq.module.ts")).then(function (m) { return m.FaqModule; }); } },
            ...
            { path: 'register', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-register-register-module */ "pages-register-register-module").then(__webpack_require__.bind(null, /*! ./pages/register/register.module */ "./src/app/pages/register/register.module.ts")).then(function (m) { return m.RegisterModule; }); } },
            { path: 'terms-conditions', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-terms-conditions-terms-conditions-module */ "pages-terms-conditions-terms-conditions-module").then(__webpack_require__.bind(null, /*! ./pages/terms-conditions/terms-conditions.module */ "./src/app/pages/terms-conditions/terms-conditions.module.ts")).then(function (m) { return m.TermsConditionsModule; }); } },
            ...
            { path: 'submit-property', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-submit-property-submit-property-module */ "pages-submit-property-submit-property-module").then(__webpack_require__.bind(null, /*! ./pages/submit-property/submit-property.module */ "./src/app/pages/submit-property/submit-property.module.ts")).then(function (m) { return m.SubmitPropertyModule; }); } }
        ]
    },
...
var Data = /** @class */ (function () {
    function Data(properties, compareList, favorites, locations) {
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.addToCompare = function (property, component, direction) {
        if (!this.Data.compareList.filter(function (item) { return item.id == property.id; })[0]) {
    ...
    AppService.prototype.addToFavorites = function (property, direction) {
        if (!this.Data.favorites.filter(function (item) { return item.id == property.id; })[0]) {
    ...
    AppService.prototype.getPropertyTypes = function () {
        return [
            { id: 1, name: 'Office' },
            { id: 2, name: 'House' },
            { id: 3, name: 'Apartment' }
    ...
    AppService.prototype.getPropertyStatuses = function () {
        return [
            { id: 1, name: 'For Sale' },
            { id: 2, name: 'For Rent' },
    ...
    AppService.prototype.getNeighborhoods = function () {
        return [
    ...
    AppService.prototype.getStreets = function () {
        return [
    ...
    AppService.prototype.getFeatures = function () {
        return [
    ...
    AppService.prototype.getHomeCarouselSlides = function () {
        return this.http.get(this.url + 'slides.json');
    };
    AppService.prototype.filterData = function (data, params, sort, page, perPage) {
        if (params) {
            if (params.propertyType) {
                data = data.filter(function (property) { return property.propertyType == params.propertyType.name; });
            }
            if (params.propertyStatus && params.propertyStatus.length) {
                var statuses_1 = [];
                params.propertyStatus.forEach(function (status) { statuses_1.push(status.name); });
                var properties_1 = [];
                data.filter(function (property) {
                    return property.propertyStatus.forEach(function (status) {
                        if (statuses_1.indexOf(status) > -1) {
                            if (!properties_1.includes(property)) {
            ...
            if (params.city) {
                data = data.filter(function (property) { return property.city == params.city.name; });
            }
            if (params.zipCode) {
                data = data.filter(function (property) { return property.zipCode == params.zipCode; });
            }
            if (params.neighborhood && params.neighborhood.length) {
                var neighborhoods_1 = [];
                params.neighborhood.forEach(function (item) { neighborhoods_1.push(item.name); });
                var properties_2 = [];
                data.filter(function (property) {
                    return property.neighborhood.forEach(function (item) {
                        if (neighborhoods_1.indexOf(item) > -1) {
                            if (!properties_2.includes(property)) {
                                properties_2.push(property);
                            }
                        }
                    });
                });
            ...
            if (params.street && params.street.length) {
                var streets_1 = [];
                params.street.forEach(function (item) { streets_1.push(item.name); });
                var properties_3 = [];
                data.filter(function (property) {
                    return property.street.forEach(function (item) {
                        if (streets_1.indexOf(item) > -1) {
                            if (!properties_3.includes(property)) {
                                properties_3.push(property);
                            }
                        }
                    });
                });
            ...
            if (params.bedrooms) {
                if (params.bedrooms.from) {
                    data = data.filter(function (property) { return property.bedrooms >= params.bedrooms.from; });
                }
                if (params.bedrooms.to) {
                    data = data.filter(function (property) { return property.bedrooms <= params.bedrooms.to; });
                }
            }
            if (params.bathrooms) {
                if (params.bathrooms.from) {
                    data = data.filter(function (property) { return property.bathrooms >= params.bathrooms.from; });
                }
                if (params.bathrooms.to) {
                    data = data.filter(function (property) { return property.bathrooms <= params.bathrooms.to; });
                }
            }
            if (params.garages) {
                if (params.garages.from) {
                    data = data.filter(function (property) { return property.garages >= params.garages.from; });
                }
                if (params.garages.to) {
                    data = data.filter(function (property) { return property.garages <= params.garages.to; });
                }
            }
            if (params.area) {
                if (params.area.from) {
                    data = data.filter(function (property) { return property.area.value >= params.area.from; });
                }
                if (params.area.to) {
                    data = data.filter(function (property) { return property.area.value <= params.area.to; });
                }
            }
            if (params.yearBuilt) {
                if (params.yearBuilt.from) {
                    data = data.filter(function (property) { return property.yearBuilt >= params.yearBuilt.from; });
                }
                if (params.yearBuilt.to) {
                    data = data.filter(function (property) { return property.yearBuilt <= params.yearBuilt.to; });
                }
            }
            if (params.features) {
                var arr_1 = [];
                params.features.forEach(function (feature) {
                    if (feature.selected)
                        arr_1.push(feature.name);
                });
                if (arr_1.length > 0) {
                    var properties_4 = [];
                    data.filter(function (property) {
                        return property.features.forEach(function (feature) {
                            if (arr_1.indexOf(feature) > -1) {
                                if (!properties_4.includes(property)) {
                                    properties_4.push(property);
                                }
                            }
                        });
                    });
    ...
    AppService.prototype.sortData = function (sort, data) {
        if (sort) {
            switch (sort) {
                case 'Newest':
                    data = data.sort(function (a, b) { return new Date(b.published) - new Date(a.published); });
                    break;
                case 'Oldest':
                    data = data.sort(function (a, b) { return new Date(a.published) - new Date(b.published); });
                    break;
                case 'Popular':
    ...
    AppService.prototype.paginator = function (items, page, perPage) {
    ...
    AppService.prototype.getTestimonials = function () {
        return [
            {
    ...
    AppService.prototype.getClients = function () {
        return [
...
var Settings = /** @class */ (function () {
    function Settings(name, theme, toolbar, stickyMenuToolbar, header, rtl, searchPanelVariant, searchOnBtnClick, currency, 
    //additional options
...
var LockScreenComponent = /** @class */ (function () {
    ...
    LockScreenComponent.prototype.onSubmit = function (values) {
        if (this.form.valid) {
...
var PagesComponent = /** @class */ (function () {
    ...
    PagesComponent.prototype.chooseToolbarType = function () {
        this.settings.toolbar = this.toolbarTypeOption;
        window.scrollTo(0, 0);
    };
    PagesComponent.prototype.chooseHeaderType = function () {
        this.settings.header = this.headerTypeOption;
        window.scrollTo(0, 0);
        this.router.navigate(['/']);
    };
    PagesComponent.prototype.chooseSearchPanelVariant = function () {
        this.settings.searchPanelVariant = this.searchPanelVariantOption;
    };
    PagesComponent.prototype.onWindowScroll = function () {
    ...
    PagesComponent.prototype.ngAfterViewInit = function () {
        ...
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]) {
                _this.sidenav.close();
                _this.settings.mainToolbarFixed = false;
                setTimeout(function () {
                    window.scrollTo(0, 0);
                });
            }
...
var AlmacenItemComponent = /** @class */ (function () {
    function AlmacenItemComponent(appSettings, appService) {
        this.appSettings = appSettings;
    ...
    AlmacenItemComponent.prototype.ngAfterViewInit = function () {
        this.initCarousel();
    ...
    AlmacenItemComponent.prototype.ngOnChanges = function (changes) {
    ...
    AlmacenItemComponent.prototype.getColumnCount = function (value) {
        if (value == 25) {
            this.column = 4;
        }
        else if (value == 33.3) {
    ...
    AlmacenItemComponent.prototype.getStatusBgColor = function (status) {
        switch (status) {
            case 'For Sale':
                return '#558B2F';
            case 'For Rent':
    ...
    AlmacenItemComponent.prototype.initCarousel = function () {
        this.config = {
            slidesPerView: 1,
            spaceBetween: 0,
            keyboard: false,
    ...
    AlmacenItemComponent.prototype.addToCompare = function () {
    ...
    AlmacenItemComponent.prototype.onCompare = function () {
        var _this = this;
        return this.appService.Data.compareList.filter(function (item) { return item.id == _this.property.id; })[0];
    };
    AlmacenItemComponent.prototype.addToFavorites = function () {
        this.appService.addToFavorites(this.property, (this.settings.rtl) ? 'rtl' : 'ltr');
    };
    AlmacenItemComponent.prototype.onFavorites = function () {
        var _this = this;
        return this.appService.Data.favorites.filter(function (item) { return item.id == _this.property.id; })[0];
    };
    AlmacenItemComponent.ctorParameters = function () { return [
...
var CommentsComponent = /** @class */ (function () {
    ...
    CommentsComponent.prototype.onCommentFormSubmit = function (values) {
    ...
    CommentsComponent.prototype.rate = function (rating) {
        this.ratings.filter(function (r) { return r.selected = false; });
        this.ratings.filter(function (r) { return r.percentage == rating.percentage; })[0].selected = true;
...
var CompareOverviewComponent = /** @class */ (function () {
    ...
    CompareOverviewComponent.prototype.ngOnInit = function () {
        this.properties = this.appService.Data.compareList;
    };
    CompareOverviewComponent.prototype.hideSheet = function (isRedirect) {
        this.bottomSheetRef.dismiss(isRedirect);
    };
    CompareOverviewComponent.prototype.remove = function (property, event) {
    ...
    CompareOverviewComponent.ctorParameters = function () { return [
...
var HeaderCarouselComponent = /** @class */ (function () {
    ...
    HeaderCarouselComponent.prototype.ngOnInit = function () {
        if (this.contentOffsetToTop)
            this.settings.contentOffsetToTop = this.contentOffsetToTop;
    };
    HeaderCarouselComponent.prototype.ngAfterViewInit = function () {
        this.initCarousel();
    };
    HeaderCarouselComponent.prototype.ngOnChanges = function () {
        if (this.slides.length > 0) {
            this.currentSlide = this.slides[0];
        }
    };
    HeaderCarouselComponent.prototype.initCarousel = function () {
        this.config = {
            slidesPerView: 1,
            spaceBetween: 0,
            keyboard: true,
    ...
    HeaderCarouselComponent.prototype.ngOnDestroy = function () {
        this.settings.contentOffsetToTop = false;
    };
    HeaderCarouselComponent.prototype.onIndexChange = function (index) {
        this.currentSlide = this.slides[index];
    };
    HeaderCarouselComponent.ctorParameters = function () { return [
        { type: _app_settings__WEBPACK_IMPORTED_MODULE_1__["AppSettings"] }
    ]; };
    __decorate([
...
var HeaderImageComponent = /** @class */ (function () {
    function HeaderImageComponent(appSettings, sanitizer, ngZone, mapaService, router, mapsAPILoader) {
        this.appSettings = appSettings;
                            ...
                            autocompleteService.getPlacePredictions({
                                ...
                                if (list == null || list.length == 0) {
                                    ...
                                    placesService.getDetails({ placeId: list[0].reference }, function (detailsResult, placesServiceStatus) {
                                        ...
                                        _this.router.navigateByUrl('/properties');
                                    });
                                }
                            });
                        }
    ...
    HeaderImageComponent.prototype.ngOnDestroy = function () {
        this.settings.headerBgImage = false;
        this.settings.contentOffsetToTop = false;
    };
    HeaderImageComponent.prototype.enviarDatos = function () {
        var _this = this;
    ...
    HeaderImageComponent.ctorParameters = function () { return [
        { type: _app_settings__WEBPACK_IMPORTED_MODULE_2__["AppSettings"] },
...
var LoadMoreComponent = /** @class */ (function () {
    ...
    LoadMoreComponent.prototype.startLoad = function () {
...
var OurAgentsComponent = /** @class */ (function () {
    function OurAgentsComponent(appService) {
        this.appService = appService;
        this.config = {};
    }
    OurAgentsComponent.prototype.ngOnInit = function () {
        this.agents = this.appService.getAgents();
    };
    OurAgentsComponent.prototype.ngAfterViewInit = function () {
        this.config = {
            observer: true,
            slidesPerView: 4,
            spaceBetween: 16,
    ...
    OurAgentsComponent.ctorParameters = function () { return [
        { type: src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"] }
    ]; };
...
var PropertiesCarouselComponent = /** @class */ (function () {
    ...
    PropertiesCarouselComponent.prototype.ngAfterViewInit = function () {
        this.config = {
            observer: true,
            slidesPerView: 4,
            spaceBetween: 16,
...
var PropertiesSearchResultsFiltersComponent = /** @class */ (function () {
    ...
    PropertiesSearchResultsFiltersComponent.prototype.ngOnInit = function () { };
    PropertiesSearchResultsFiltersComponent.prototype.remove = function (field) {
...
var PropertiesSearchComponent = /** @class */ (function () {
    ...
    PropertiesSearchComponent.prototype.ngOnInit = function () {
        if (this.vertical) {
            this.showMore = true;
        }
        ;
    ...
    PropertiesSearchComponent.prototype.buildFeatures = function () {
        var _this = this;
    ...
    PropertiesSearchComponent.prototype.ngOnChanges = function () {
    ...
    PropertiesSearchComponent.prototype.reset = function () {
        this.form.reset({
            propertyType: null,
            propertyStatus: null,
            price: {
    ...
    PropertiesSearchComponent.prototype.search = function () {
        this.onSearchClick.emit();
    };
    PropertiesSearchComponent.prototype.onSelectCity = function () {
        this.form.controls['neighborhood'].setValue(null, { emitEvent: false });
        this.form.controls['street'].setValue(null, { emitEvent: false });
    };
    PropertiesSearchComponent.prototype.onSelectNeighborhood = function () {
        this.form.controls['street'].setValue(null, { emitEvent: false });
    };
    PropertiesSearchComponent.prototype.getAppearance = function () {
        return (this.variant != 3) ? 'outline' : '';
    };
    PropertiesSearchComponent.prototype.getFloatLabel = function () {
        return (this.variant == 1) ? 'always' : '';
    };
    PropertiesSearchComponent.ctorParameters = function () { return [
...
var PropertiesToolbarComponent = /** @class */ (function () {
    ...
    PropertiesToolbarComponent.prototype.ngOnChanges = function () {
        // console.log(' show toggle - ' ,this.showSidenavToggle)
    };
    PropertiesToolbarComponent.prototype.changeCount = function (count) {
        this.count = count;
        this.onChangeCount.emit(count);
        // this.getAllProducts(); 
    };
    PropertiesToolbarComponent.prototype.changeSorting = function (sort) {
        this.sort = sort;
        this.onChangeSorting.emit(sort);
    };
    PropertiesToolbarComponent.prototype.changeViewType = function (viewType, viewCol) {
        this.viewType = viewType;
        this.viewCol = viewCol;
        this.onChangeViewType.emit({ viewType: viewType, viewCol: viewCol });
    };
    PropertiesToolbarComponent.prototype.sidenavToggle = function () {
...
var PropertyItemComponent = /** @class */ (function () {
    ...
    PropertyItemComponent.prototype.ngAfterViewInit = function () {
        this.initCarousel();
        // this.appService.getAddress(this.property.location.lat, this.property.location.lng).subscribe(data=>{
        //   console.log(data['results'][0]['formatted_address']);
        //   this.address = data['results'][0]['formatted_address'];
    ...
    PropertyItemComponent.prototype.getColumnCount = function (value) {
        if (value == 25) {
            this.column = 4;
        }
        else if (value == 33.3) {
    ...
    PropertyItemComponent.prototype.getStatusBgColor = function (status) {
        switch (status) {
            case 'For Sale':
                return '#558B2F';
            case 'For Rent':
    ...
    PropertyItemComponent.prototype.initCarousel = function () {
        this.config = {
            slidesPerView: 1,
            spaceBetween: 0,
            keyboard: false,
    ...
    PropertyItemComponent.prototype.addToCompare = function () {
        this.appService.addToCompare(this.property, _compare_overview_compare_overview_component__WEBPACK_IMPORTED_MODULE_5__["CompareOverviewComponent"], (this.settings.rtl) ? 'rtl' : 'ltr');
    };
    PropertyItemComponent.prototype.onCompare = function () {
        var _this = this;
        return this.appService.Data.compareList.filter(function (item) { return item.id == _this.property.id; })[0];
    };
    PropertyItemComponent.prototype.addToFavorites = function () {
        this.appService.addToFavorites(this.property, (this.settings.rtl) ? 'rtl' : 'ltr');
    };
    PropertyItemComponent.prototype.onFavorites = function () {
        var _this = this;
        return this.appService.Data.favorites.filter(function (item) { return item.id == _this.property.id; })[0];
    };
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent.prototype.onFeedbackFormSubmit = function (values) {
        if (this.feedbackForm.valid) {
            console.log(values);
        }
    };
    FooterComponent.prototype.onSubscribeFormSubmit = function (values) {
...
var LangComponent = /** @class */ (function () {
    ...
    LangComponent.prototype.changeLang = function (flag) {
        this.flag = flag;
    };
...
var Menu = /** @class */ (function () {
    function Menu(id, title, routerLink, href, target, hasSubMenu, parentId) {
        this.id = id;
        this.title = title;
...
var Toolbar1Component = /** @class */ (function () {
    function Toolbar1Component(appService) {
        this.appService = appService;
        this.onMenuIconClick = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    Toolbar1Component.prototype.ngOnInit = function () { };
    Toolbar1Component.prototype.sidenavToggle = function () {
        this.onMenuIconClick.emit();
    };
    Toolbar1Component.ctorParameters = function () { return [
        { type: src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"] }
    ]; };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
...
var Toolbar2Component = /** @class */ (function () {
    ...
    Toolbar2Component.prototype.ngOnInit = function () { };
    Toolbar2Component.prototype.sidenavToggle = function () {
        this.onMenuIconClick.emit();
    };
...
var OnlyNumberDirective = /** @class */ (function () {
    ...
    OnlyNumberDirective.prototype.onInputChange = function (e) {
...
var FilterNeighborhoodsPipe = /** @class */ (function () {
    function FilterNeighborhoodsPipe() {
    }
    FilterNeighborhoodsPipe.prototype.transform = function (items, id) {
        if (id) {
            return items.filter(function (item) { return item.cityId == id; });
        }
        return items;
    };
...
var FilterStreetsPipe = /** @class */ (function () {
    function FilterStreetsPipe() {
    }
    FilterStreetsPipe.prototype.transform = function (items, filter) {
        var neighborhoodIds = [];
        ...
        if (filter.cityId) {
            return items.filter(function (item) { return item.cityId == filter.cityId; });
        }
        return items;
    };
