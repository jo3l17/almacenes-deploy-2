...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/account/edit-property/edit-property.component.html":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/account/edit-property/edit-property.component.html ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/account/favorites/favorites.component.html":
/*!********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/account/favorites/favorites.component.html ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/account/my-properties/my-properties.component.html":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/account/my-properties/my-properties.component.html ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/account/profile/profile.component.html":
/*!****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/account/profile/profile.component.html ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* harmony import */ var ngx_input_file__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-input-file */ "./node_modules/ngx-input-file/fesm5/ngx-input-file.js");
...
module.exports = ".edit-property .sebm-google-map-container {\n  height: 400px;\n}\n.edit-property .step-section {\n  padding: 20px 10px 0;\n  border-radius: 4px;\n  margin: 8px 8px 16px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var EditPropertyComponent = /** @class */ (function () {
    ...
    EditPropertyComponent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
    };
    EditPropertyComponent.prototype.getPropertyById = function (id) {
        var _this = this;
        this.appService.getPropertyById(id).subscribe(function (data) {
            console.log(data);
            _this.property = data;
            _this.submitForm.controls.basic.get('title').setValue(_this.property.title);
            _this.submitForm.controls.basic.get('desc').setValue(_this.property.desc);
            _this.submitForm.controls.basic.get('priceDollar').setValue((_this.property.priceDollar.sale) ? _this.property.priceDollar.sale : _this.property.priceDollar.rent);
            _this.submitForm.controls.basic.get('priceEuro').setValue((_this.property.priceEuro.sale) ? _this.property.priceEuro.sale : _this.property.priceEuro.rent);
            _this.submitForm.controls.basic.get('propertyType').setValue(_this.propertyTypes.filter(function (p) { return p.name == _this.property.propertyType; })[0]);
            var statusList = [];
            _this.propertyStatuses.forEach(function (status) {
                _this.property.propertyStatus.forEach(function (name) {
                    if (status.name == name) {
                        statusList.push(status);
                    }
                });
            });
            _this.submitForm.controls.basic.get('propertyStatus').setValue(statusList);
            var images = [];
            _this.property.gallery.forEach(function (item) {
                var image = {
                    link: item.medium,
                    preview: item.medium
                };
            ...
            _this.submitForm.controls.basic.get('gallery').setValue(images);
            _this.submitForm.controls.address.get('location').setValue(_this.property.formattedAddress);
            _this.lat = _this.property.location.lat;
            _this.lng = _this.property.location.lng;
            _this.getAddress();
            _this.submitForm.controls.additional.get('bedrooms').setValue(_this.property.bedrooms);
            _this.submitForm.controls.additional.get('bathrooms').setValue(_this.property.bathrooms);
            _this.submitForm.controls.additional.get('garages').setValue(_this.property.garages);
            _this.submitForm.controls.additional.get('area').setValue(_this.property.area.value);
            _this.submitForm.controls.additional.get('yearBuilt').setValue(_this.property.yearBuilt);
            _this.features.forEach(function (feature) {
                _this.property.features.forEach(function (name) {
                    if (feature.name == name) {
                        feature.selected = true;
                    }
                });
            });
            _this.submitForm.controls.additional.get('features').setValue(_this.features);
            var videos = _this.submitForm.controls.media.get('videos');
            while (videos.length) {
                videos.removeAt(0);
            }
            _this.property.videos.forEach(function (video) { return videos.push(_this.fb.group(video)); });
            var plans = _this.submitForm.controls.media.get('plans');
            while (plans.length) {
                plans.removeAt(0);
            }
            _this.property.plans.forEach(function (plan) {
                var p = {
                    id: plan.id,
                    name: plan.name,
                    desc: plan.desc,
                ...
                plans.push(_this.fb.group(p));
            });
            _this.property.plans.forEach(function (plan, index) {
                var image = {
                    link: plan.image,
                    preview: plan.image
                };
                _this.submitForm.controls.media.get('plans')['controls'][index].controls.image.setValue([image]);
            });
            var additionalFeatures = _this.submitForm.controls.media.get('additionalFeatures');
            while (additionalFeatures.length) {
                additionalFeatures.removeAt(0);
            }
            _this.property.additionalFeatures.forEach(function (feature) { return additionalFeatures.push(_this.fb.group(feature)); });
            _this.submitForm.controls.media.get('featured').setValue(_this.property.featured);
        });
    };
    // -------------------- Address ---------------------------  
    EditPropertyComponent.prototype.onSelectCity = function () {
    ...
    EditPropertyComponent.prototype.onSelectNeighborhood = function () {
        this.submitForm.controls.address.get('street').setValue(null, { emitEvent: false });
    };
    EditPropertyComponent.prototype.setCurrentPosition = function () {
        var _this = this;
    ...
    EditPropertyComponent.prototype.placesAutocomplete = function () {
        var _this = this;
    ...
    EditPropertyComponent.prototype.getAddress = function () {
        var _this = this;
    ...
    EditPropertyComponent.prototype.onMapClick = function (e) {
        this.lat = e.coords.lat;
        this.lng = e.coords.lng;
        this.getAddress();
    };
    EditPropertyComponent.prototype.onMarkerClick = function (e) {
        console.log(e);
    };
    EditPropertyComponent.prototype.setAddresses = function (result) {
        var _this = this;
    ...
    // -------------------- Additional ---------------------------  
    EditPropertyComponent.prototype.buildFeatures = function () {
        var _this = this;
    ...
    // -------------------- Media --------------------------- 
    EditPropertyComponent.prototype.createVideo = function () {
    ...
    EditPropertyComponent.prototype.addVideo = function () {
        var videos = this.submitForm.controls.media.get('videos');
        videos.push(this.createVideo());
    };
    EditPropertyComponent.prototype.deleteVideo = function (index) {
        var videos = this.submitForm.controls.media.get('videos');
        videos.removeAt(index);
    };
    EditPropertyComponent.prototype.createPlan = function () {
        return this.fb.group({
            id: null,
            name: null,
            desc: null,
    ...
    EditPropertyComponent.prototype.addPlan = function () {
        var plans = this.submitForm.controls.media.get('plans');
        plans.push(this.createPlan());
    };
    EditPropertyComponent.prototype.deletePlan = function (index) {
        var plans = this.submitForm.controls.media.get('plans');
        plans.removeAt(index);
    };
    EditPropertyComponent.prototype.createFeature = function () {
        return this.fb.group({
            id: null,
            name: null,
            value: null
    ...
    EditPropertyComponent.prototype.addFeature = function () {
        var features = this.submitForm.controls.media.get('additionalFeatures');
        features.push(this.createFeature());
    };
    EditPropertyComponent.prototype.deleteFeature = function (index) {
        var features = this.submitForm.controls.media.get('additionalFeatures');
        features.removeAt(index);
    };
    EditPropertyComponent.prototype.setStep = function (index) {
        this.step = index;
    };
    EditPropertyComponent.prototype.onSubmitForm = function (form) {
    ...
    EditPropertyComponent.prototype.nextStep = function () {
        this.step++;
    };
    EditPropertyComponent.prototype.prevStep = function () {
        this.step--;
    };
    ...
    ], EditPropertyComponent.prototype, "addressAutocomplete", void 0);
    EditPropertyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-edit-property',
            template: __webpack_require__(/*! raw-loader!./edit-property.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/account/edit-property/edit-property.component.html"),
            styles: [__webpack_require__(/*! ./edit-property.component.scss */ "./src/app/pages/account/edit-property/edit-property.component.scss")]
        }),
...
var FavoritesComponent = /** @class */ (function () {
    ...
    FavoritesComponent.prototype.ngOnInit = function () {
        this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.appService.Data.favorites);
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    FavoritesComponent.prototype.remove = function (property) {
    ...
    FavoritesComponent.prototype.applyFilter = function (filterValue) {
    ...
    ], FavoritesComponent.prototype, "paginator", void 0);
    __decorate([
    ...
    ], FavoritesComponent.prototype, "sort", void 0);
    FavoritesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-favorites',
            template: __webpack_require__(/*! raw-loader!./favorites.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/account/favorites/favorites.component.html"),
            styles: [__webpack_require__(/*! ./favorites.component.scss */ "./src/app/pages/account/favorites/favorites.component.scss")]
        }),
        __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"]])
    ], FavoritesComponent);
...
var MyPropertiesComponent = /** @class */ (function () {
    ...
    MyPropertiesComponent.prototype.remove = function (property) {
        var index = this.dataSource.data.indexOf(property);
        if (index !== -1) {
            this.dataSource.data.splice(index, 1);
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.dataSource.data);
    ...
    MyPropertiesComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    MyPropertiesComponent.ctorParameters = function () { return [
        { type: src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"] }
    ]; };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], { static: true }),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"])
    ], MyPropertiesComponent.prototype, "paginator", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"], { static: true }),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSort"])
    ], MyPropertiesComponent.prototype, "sort", void 0);
    MyPropertiesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-my-properties',
            template: __webpack_require__(/*! raw-loader!./my-properties.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/account/my-properties/my-properties.component.html"),
            styles: [__webpack_require__(/*! ./my-properties.component.scss */ "./src/app/pages/account/my-properties/my-properties.component.scss")]
        }),
        __metadata("design:paramtypes", [src_app_app_service__WEBPACK_IMPORTED_MODULE_1__["AppService"]])
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.onInfoFormSubmit = function (values) {
        if (this.infoForm.valid) {
            console.log(values);
            this.snackBar.open('Your account information updated successfully!', '×', { panelClass: 'success', verticalPosition: 'top', duration: 3000 });
        }
    };
    ProfileComponent.prototype.onPasswordFormSubmit = function (values) {
    ...
    ProfileComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./profile.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/account/profile/profile.component.html"),
            styles: [__webpack_require__(/*! ./profile.component.scss */ "./src/app/pages/account/profile/profile.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]])
    ], ProfileComponent);
