...
/***/ "./node_modules/mat-video/fesm5/mat-video.js":
/*!***************************************************!*\
  !*** ./node_modules/mat-video/fesm5/mat-video.js ***!
  \***************************************************/
...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.addEvents = function (renderer, events) {
        ...
        try {
            for (var events_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(events), events_1_1 = events_1.next(); !events_1_1.done; events_1_1 = events_1.next()) {
    ...
    EventService.prototype.removeEvents = function (events) {
        var e_2, _a;
        try {
            for (var events_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(events), events_2_1 = events_2.next(); !events_2_1.done; events_2_1 = events_2.next()) {
...
var MatSliderProgressBarComponent = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(MatSliderProgressBarComponent, _super);
...
}(_angular_material_slider__WEBPACK_IMPORTED_MODULE_5__["MatSlider"]));
...
var MapComponent = /** @class */ (function () {
    function MapComponent(mapaService) {
        var _this = this;
    ...
    MapComponent.prototype.doSomething = function (e) {
        console.log(e);
    };
    MapComponent.prototype.doSomething2 = function (e) {
        if (this.zoom >= 13) {
            this.resta = 0.015;
        }
        else {
    ...
    MapComponent.prototype.busqueda = function (e) {
        var _this = this;
    ...
    MapComponent.prototype.openWindow = function (id) {
    ...
    MapComponent.prototype.isInfoWindowOpen = function (id) {
        return this.openedWindow == id;
    };
    MapComponent.prototype.ngOnInit = function () {
    };
    MapComponent.prototype.recenterMap = function (lat, lng) {
        this.lat = lat;
        this.lng = lng;
        // console.log(lat, lng)
    };
    MapComponent.prototype.updateMapCenter = function () {
    ...
    MapComponent.prototype.enable = function () {
...
var PropertiesComponent = /** @class */ (function () {
    function PropertiesComponent(appSettings, appService, mediaObserver, mapaService) {
        var _this = this;
    ...
    PropertiesComponent.prototype.mapa = function () {
    ...
    PropertiesComponent.prototype.getProperties = function () {
        ...
        this.mapaService.getPropeties().subscribe(function (data) {
            ...
            console.log(result);
            if (result.data.length == 0) {
                _this.almacenes.length = 0;
                _this.pagination = new _app_models__WEBPACK_IMPORTED_MODULE_6__["Pagination"](1, _this.count, null, 2, 0, 0);
                _this.message = 'No Results Found';
                return false;
            }
            // console.log(result.data)
            _this.almacenes = [];
            _this.almacenes = result.data;
            _this.pagination = result.pagination;
            _this.message = null;
            console.log(_this.almacenes);
        });
    };
    PropertiesComponent.prototype.resetPagination = function () {
        if (this.paginator) {
    ...
    PropertiesComponent.prototype.filterData = function (data) {
        return this.appService.filterData(data, this.searchFields, this.sort, this.pagination.page, this.pagination.perPage);
    };
    PropertiesComponent.prototype.searchClicked = function () {
        this.properties.length = 0;
        this.getProperties();
        window.scrollTo(0, 0);
    };
    PropertiesComponent.prototype.searchChanged = function (event) {
        var _this = this;
    ...
    PropertiesComponent.prototype.removeSearchField = function (field) {
        this.message = null;
        this.removedSearchField = field;
    };
    PropertiesComponent.prototype.changeCount = function (count) {
        this.count = count;
        this.properties.length = 0;
        this.resetPagination();
        this.getProperties();
    };
    PropertiesComponent.prototype.changeSorting = function (sort) {
        this.sort = sort;
        this.properties.length = 0;
        this.getProperties();
    };
    PropertiesComponent.prototype.changeViewType = function (obj) {
        this.viewType = obj.viewType;
        this.viewCol = obj.viewCol;
    };
    PropertiesComponent.prototype.onPageChange = function (e) {
...
var PropertyComponent = /** @class */ (function () {
    ...
    PropertyComponent.prototype.onWindowResize = function () {
        (window.innerWidth < 960) ? this.sidenavOpen = false : this.sidenavOpen = true;
    };
    PropertyComponent.prototype.getPropertyById = function (id) {
        var _this = this;
        this.appService.getPropertyById(id).subscribe(function (data) {
            _this.property = data;
            _this.embedVideo = _this.embedService.embed(_this.property.videos[1].link);
            setTimeout(function () {
                _this.config.observer = true;
                _this.config2.observer = true;
                _this.swipers.forEach(function (swiper) {
                    if (swiper) {
                        swiper.setIndex(0);
                    }
                });
    ...
    PropertyComponent.prototype.onOpenedChange = function () {
    ...
    PropertyComponent.prototype.selectImage = function (index) {
        this.swipers.forEach(function (swiper) {
    ...
    PropertyComponent.prototype.addToCompare = function () {
    ...
    PropertyComponent.prototype.onCompare = function () {
        var _this = this;
        return this.appService.Data.compareList.filter(function (item) { return item.id == _this.property.id; })[0];
    };
    PropertyComponent.prototype.addToFavorites = function () {
        this.appService.addToFavorites(this.property, (this.settings.rtl) ? 'rtl' : 'ltr');
    };
    PropertyComponent.prototype.onFavorites = function () {
        var _this = this;
        return this.appService.Data.favorites.filter(function (item) { return item.id == _this.property.id; })[0];
    };
    PropertyComponent.prototype.getRelatedProperties = function () {
        var _this = this;
        this.appService.getRelatedProperties().subscribe(function (properties) {
            _this.relatedProperties = properties;
        });
    };
    PropertyComponent.prototype.getFeaturedProperties = function () {
        var _this = this;
        this.appService.getFeaturedProperties().subscribe(function (properties) {
            _this.featuredProperties = properties.slice(0, 3);
        });
    };
    PropertyComponent.prototype.getAgent = function (agentId) {
        if (agentId === void 0) { agentId = 1; }
        var ids = [1, 2, 3, 4, 5]; //agent ids 
        agentId = ids[Math.floor(Math.random() * ids.length)]; //random agent id
        this.agent = this.appService.getAgents().filter(function (agent) { return agent.id == agentId; })[0];
    };
    PropertyComponent.prototype.onContactFormSubmit = function (values) {
        if (this.contactForm.valid) {
            console.log(values);
        }
    };
    PropertyComponent.prototype.onMortgageFormSubmit = function (values) {
    ...
    PropertyComponent.prototype.calculateMortgage = function (principalAmount, downPayment, interestRate, period) {
