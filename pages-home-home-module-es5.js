...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/home/featured-properties/featured-properties.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/home/featured-properties/featured-properties.component.html ***!
  \*************************************************************************************************************/
...
var FeaturedPropertiesComponent = /** @class */ (function () {
    ...
    ], FeaturedPropertiesComponent.prototype, "featuredProperties", void 0);
    FeaturedPropertiesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-featured-properties',
            template: __webpack_require__(/*! raw-loader!./featured-properties.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/home/featured-properties/featured-properties.component.html"),
            styles: [__webpack_require__(/*! ./featured-properties.component.scss */ "./src/app/pages/home/featured-properties/featured-properties.component.scss")]
        }),
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getSlides = function () {
        var _this = this;
    ...
    HomeComponent.prototype.getProperties = function () {
        ...
        this.appService.getProperties().subscribe(function (data) {
            if (_this.properties && _this.properties.length > 0) {
                _this.settings.loadMore.page++;
                _this.pagination.page = _this.settings.loadMore.page;
            }
            var result = _this.filterData(data);
            if (result.data.length == 0) {
                _this.properties.length = 0;
                _this.pagination = new _app_models__WEBPACK_IMPORTED_MODULE_3__["Pagination"](1, _this.count, null, 2, 0, 0);
                _this.message = 'No Results Found';
                return false;
            }
            if (_this.properties && _this.properties.length > 0) {
                _this.properties = _this.properties.concat(result.data);
            }
            else {
            ...
            _this.message = null;
            if (_this.properties.length == _this.pagination.total) {
                _this.settings.loadMore.complete = true;
                _this.settings.loadMore.result = _this.properties.length;
            }
            else {
                _this.settings.loadMore.complete = false;
            }
        });
    };
    HomeComponent.prototype.resetLoadMore = function () {
    ...
    HomeComponent.prototype.filterData = function (data) {
        return this.appService.filterData(data, this.searchFields, this.sort, this.pagination.page, this.pagination.perPage);
    };
    HomeComponent.prototype.searchClicked = function () {
        this.properties.length = 0;
        this.getProperties();
    };
    HomeComponent.prototype.searchChanged = function (event) {
        var _this = this;
    ...
    HomeComponent.prototype.removeSearchField = function (field) {
        this.message = null;
        this.removedSearchField = field;
    };
    HomeComponent.prototype.changeCount = function (count) {
        this.count = count;
        this.resetLoadMore();
        this.properties.length = 0;
        this.getProperties();
    };
    HomeComponent.prototype.changeSorting = function (sort) {
        this.sort = sort;
        this.resetLoadMore();
        this.properties.length = 0;
        this.getProperties();
    };
    HomeComponent.prototype.changeViewType = function (obj) {
        this.viewType = obj.viewType;
        this.viewCol = obj.viewCol;
    };
    HomeComponent.prototype.getFeaturedProperties = function () {
        var _this = this;
        this.appService.getFeaturedProperties().subscribe(function (properties) {
            _this.featuredProperties = properties;
        });
    };
...
var HotOfferTodayComponent = /** @class */ (function () {
    function HotOfferTodayComponent(appService) {
        this.appService = appService;
    }
    HotOfferTodayComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appService.getPropertyById(this.propertyId).subscribe(function (property) {
            _this.property = property;
        });
    };
    HotOfferTodayComponent.ctorParameters = function () { return [
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], HotOfferTodayComponent.prototype, "propertyId", void 0);
    HotOfferTodayComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-hot-offer-today',
            template: __webpack_require__(/*! raw-loader!./hot-offer-today.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/home/hot-offer-today/hot-offer-today.component.html"),
            styles: [__webpack_require__(/*! ./hot-offer-today.component.scss */ "./src/app/pages/home/hot-offer-today/hot-offer-today.component.scss")]
        }),
