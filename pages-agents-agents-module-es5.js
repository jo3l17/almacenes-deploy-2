...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/agents/agent/agent.component.html":
/*!***********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/agents/agent/agent.component.html ***!
  \***********************************************************************************/
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/agents/agents.component.html":
/*!******************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/agents/agents.component.html ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = ".agent-wrapper {\n  margin: -24px !important;\n}\n.agent-wrapper img {\n  border-radius: 4px;\n}\n.agent-wrapper .listed-count {\n  font-weight: 600;\n  min-width: 24px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AgentComponent = /** @class */ (function () {
    ...
    AgentComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.activatedRoute.params.subscribe(function (params) {
            _this.agentId = params['id'];
            _this.getAgentById(params['id']);
            _this.getProperties();
        });
    ...
    AgentComponent.prototype.getAgentById = function (id) {
        this.agent = this.appService.getAgents().filter(function (agent) { return agent.id == id; })[0];
    };
    AgentComponent.prototype.getProperties = function () {
        var _this = this;
        this.appService.getPropertiesByAgentId(this.agentId).subscribe(function (data) {
            var result = _this.filterData(data);
            if (result.data.length == 0) {
                _this.properties.length = 0;
                _this.pagination = new src_app_app_models__WEBPACK_IMPORTED_MODULE_8__["Pagination"](1, _this.count, null, 2, 0, 0);
                _this.message = 'No Results Found';
                return false;
            }
    ...
    AgentComponent.prototype.resetPagination = function () {
        if (this.paginator) {
    ...
    AgentComponent.prototype.filterData = function (data) {
        return this.appService.filterData(data, this.searchFields, this.sort, this.pagination.page, this.pagination.perPage);
    };
    AgentComponent.prototype.searchClicked = function () {
        this.properties.length = 0;
        this.getProperties();
        window.scrollTo(0, 0);
    };
    AgentComponent.prototype.searchChanged = function (event) {
        var _this = this;
        event.valueChanges.subscribe(function () {
            _this.resetPagination();
            _this.searchFields = event.value;
            setTimeout(function () {
                _this.removedSearchField = null;
            });
            if (!_this.settings.searchOnBtnClick) {
                _this.properties.length = 0;
            }
        });
    ...
    AgentComponent.prototype.removeSearchField = function (field) {
        this.message = null;
        this.removedSearchField = field;
    };
    AgentComponent.prototype.changeCount = function (count) {
        this.count = count;
        this.properties.length = 0;
        this.resetPagination();
        this.getProperties();
    };
    AgentComponent.prototype.changeSorting = function (sort) {
        this.sort = sort;
        this.properties.length = 0;
        this.getProperties();
    };
    AgentComponent.prototype.changeViewType = function (obj) {
        this.viewType = obj.viewType;
        this.viewCol = obj.viewCol;
    };
    AgentComponent.prototype.onPageChange = function (e) {
        this.pagination.page = e.pageIndex + 1;
        this.getProperties();
        window.scrollTo(0, 0);
    };
    AgentComponent.prototype.onContactFormSubmit = function (values) {
    ...
    ], AgentComponent.prototype, "sidenav", void 0);
    __decorate([
    ...
    ], AgentComponent.prototype, "paginator", void 0);
    AgentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-agent',
            template: __webpack_require__(/*! raw-loader!./agent.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/agents/agent/agent.component.html"),
            styles: [__webpack_require__(/*! ./agent.component.scss */ "./src/app/pages/agents/agent/agent.component.scss")]
        }),
...
module.exports = ".agents-wrapper {\n  margin: -16px;\n  padding: 32px 0;\n}\n.agents-wrapper .agent-img {\n  border-top-left-radius: inherit;\n  border-top-right-radius: inherit;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AgentsComponent = /** @class */ (function () {
    ...
    AgentsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-agents',
            template: __webpack_require__(/*! raw-loader!./agents.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/agents/agents.component.html"),
            styles: [__webpack_require__(/*! ./agents.component.scss */ "./src/app/pages/agents/agents.component.scss")]
        }),
