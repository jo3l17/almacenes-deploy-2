...
/* harmony import */ var ngx_input_file__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-input-file */ "./node_modules/ngx-input-file/fesm2015/ngx-input-file.js");
...
let MyPropertiesComponent = class MyPropertiesComponent {
    ...
    ngOnInit() {
        this.appService.getProperties().subscribe(res => {
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](res);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
        });
    }
